...
const int EYE_MINSPEED_UP=180;
const int EYE_MINSPEED_DOWN=160;
int EYE_MAXSPEED=255;
const int eyeUpAccel=4;
const int eyeDownAccel=3;
      ...
      case MODE_ZERO:
        switch (mode_2) {
          ...
          case MODE_ZERO_SET_HEAD:
            switch (key) {
              case '2': // top limit
                headUp = chuckPitch/10;
                EEPROM.write(EEPROM_headUp,headUp);
                break;
              case '8': // bottom limit
                headDown = chuckPitch/10;
